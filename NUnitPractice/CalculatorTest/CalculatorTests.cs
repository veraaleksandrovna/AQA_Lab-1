...
public class Tests
{
    ...
    public void DivideIntegerMethodTest(int firstNumber, int secondNumber, int expectedResult)
    {
        TestContext.Out.WriteLineAsync("First number is " + firstNumber);
        TestContext.Out.WriteLineAsync("Second number is" + secondNumber);
    ...
    [TestCase(0, 0)]
    public void DivideInteger_DivideByZero_ThrowException(int firstNumber, int secondNumber)
    {
    ...
    public void DivideDoubleMethodTest(double firstNumber, double secondNumber, double expectedResult)
    {
        TestContext.Out.WriteLineAsync("First number is " + firstNumber);
        TestContext.Out.WriteLineAsync("Second number is" + secondNumber);
    ...
    [Test]
    [Category("SmokeTest")]
    public void DivideDouble_DivideByZero_True()
    {
