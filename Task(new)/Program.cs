...
namespace DriverAndCars
{
    public static class Program
    {
        ...
        {
            var drivers = FakeData.CreateDriver(ammount);
            PrintDrivers(drivers);
            var vehicles = FakeData.CreateVehicle(drivers, ammount);
            Driver chosenDriver;
            do
            {
            ...
            var newChoice = int.Parse(Console.ReadLine() ?? string.Empty);
        ...
        private static void PrintVehicle(List<Vehicle> vehicles)
        {
            foreach (var vehicle in vehicles)
            {
